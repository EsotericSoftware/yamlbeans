...
public class FlowSequenceStartStrategy extends AbstractEventStrategy {

    public FlowSequenceStartStrategy(Parser parser) {
        super(parser);
    }
    ...
    public Event getEvent() {
        ...
        parser.getNextToken();
        return new SequenceStartEvent(parser.getAnchor(0), parser.getTag(0), implicit, true);
    }
}
